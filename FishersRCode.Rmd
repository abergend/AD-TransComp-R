...
# import the pca_loadings.csv and spca_loadings.csv 

SB40 <- read.csv("SB40_orthologs_pca.csv", row.names = 1) 
SB40_df <- as.data.frame(SB40)
#pca_loadings <- data.frame(read.csv("/Users/park1102/Downloads/pca_loadings.csv", row.names = 1))
...
for (x in 1:ncol(pca_cont_df)) {
  cont_df <- data.frame(
    "PCA yes" = pca_cont_df[c(1,3),x],
    "PCA no" = pca_cont_df[c(2,4),x],
    row.names = c("Drug yes", "Drug no"),
...
#SB40 <- read.csv("/Users/park1102/Downloads/SB40_orthologs_pca.csv", row.names = 1) 
#SB40_df <- as.data.frame(SB40)
#pca_loadings <- data.frame(read.csv("/Users/park1102/Downloads/pca_loadings.csv", row.names = 1))
...
for (x in 1:ncol(spca_cont_df)) {
  cont_df <- data.frame(
    "sPCA yes" = spca_cont_df[c(1,3),x],
    "sPCA no" = spca_cont_df[c(2,4),x],
    row.names = c("Drug yes", "Drug no"),
    stringsAsFactors = FALSE
  )

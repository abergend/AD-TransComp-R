...
```{r}
p1 <- DimPlot(human, reduction = "spca_projections", dims = c(6, 2), group.by = "Genotype")
```

```{r}
cairo_ps(filename= paste0(home_dir, "/Figures/Figure 3/3D_spca.eps"), width = 7, height = 7) # name the file as an EPS

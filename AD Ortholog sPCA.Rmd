...
```{r}
# Run GLM
ad.model2 <- glm(dv ~ spcaproj_1 + spcaproj_2 + spcaproj_3 + spcaproj_4 + spcaproj_5 + 
                  spcaproj_6 + spcaproj_7 + spcaproj_8 + spcaproj_9 + 
                  spcaproj_12 + spcaproj_13 + spcaproj_14 +
                  spcaproj_19 + spcaproj_20 +
                  spcaproj_21 + spcaproj_22 + spcaproj_23 + spcaproj_24 + spcaproj_25 +
                  spcaproj_27 + spcaproj_28 + 
                  spcaproj_32 + spcaproj_33 + spcaproj_35 +
                   spcaproj_40 + 
                  spcaproj_42 + spcaproj_49 + spcaproj_50,
...
Highly significant PCs include 1, 2, 3, 6, 7, 12, 21, 27

```{r}
# Run GLM
ad.model3 <- glm(dv ~ spcaproj_1 + spcaproj_2 + spcaproj_3 + 
                  spcaproj_6 + spcaproj_7 +
                  spcaproj_12 +
                  spcaproj_21 + 
                  spcaproj_27, data = human@meta.data, family = binomial)
```
...
```{r}
DimPlot(human, reduction = "spca_projections", dims = c(2, 6F), group.by = "Genotype")
```

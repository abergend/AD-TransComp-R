...
```{r}
write.csv(drug, file = paste0(home_dir, "/drug_orthologs/SB40_orthologs.csv"), row.names = TRUE)
```
...
```{r}
#write.csv(drug_mouse_cor_pca, file = paste0(home_dir, "/correlations/SB408124_pca_nofilter.csv"))
write.csv(drug_mouse_cor_pca, file = paste0(home_dir, "/correlations/SB408124_pca_filter.csv"))
```

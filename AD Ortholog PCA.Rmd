...
```{r}
combined <- subset(combined, subset = sub.cluster %in% c("2_3", "3", "4", "6"), invert = TRUE)
```
...
ad.model2 <- glm(dv ~ pcaproj_1 + pcaproj_2 + pcaproj_3 + 
                  pcaproj_6 + pcaproj_7 + pcaproj_8 + pcaproj_9 + pcaproj_10 +
                  pcaproj_10 + pcaproj_11 + pcaproj_12 + pcaproj_13 + pcaproj_15 +
                  pcaproj_17 + pcaproj_19 + pcaproj_20 +
                  pcaproj_22 + pcaproj_23 +
                  pcaproj_29 + pcaproj_30 +
                  pcaproj_32 + pcaproj_33 + pcaproj_34  +
                  pcaproj_36 + pcaproj_37 + 
                  pcaproj_48 + pcaproj_49 , data = human@meta.data, family = binomial)
...
ad.model3 <- glm(dv ~ pcaproj_1 + pcaproj_3 + 
                  pcaproj_6 + pcaproj_7 + pcaproj_8 + pcaproj_9 + pcaproj_10 +
                  pcaproj_11 + pcaproj_13 +
                  pcaproj_15 + pcaproj_17 +
                  pcaproj_33 + 
                  pcaproj_48 + pcaproj_49
...
## Visualize PCs
```{r}
DimPlot(human, reduction = "pca_projections", dims = c(1, 3), group.by = "Genotype")
```

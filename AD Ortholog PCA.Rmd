...
## Visualize PCs
```{r}
p1 <- DimPlot(human, reduction = "pca_projections", dims = c(1, 9), group.by = "Genotype")
```

```{r}
cairo_ps(filename= paste0(home_dir, "/Figures/Figure 3/3D_pca.eps"), width = 7, height = 7) # name the file as an EPS
p1 #variable of the figure that is defined/saved, can be used any name
dev.off()
```
